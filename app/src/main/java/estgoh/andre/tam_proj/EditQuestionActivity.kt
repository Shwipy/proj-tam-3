...
class EditQuestionActivity : AppCompatActivity() {
    ...
    lateinit var correct_answer: RadioButton
...
//    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //implementar pedido get do coiso da question toda
//        var question = Daos(this).question.getQuestion(questId)
        val context = this
        getQuestionData(questId, context)
    ...
    fun getQuestionData(quest_id: Long, context: Context){
        ...
        lifecycleScope.launch{
            ...
            try {
                ...
                val response = appService.getQuestion("Bearer $token", quest_id)
                val body: Question? = response.body()
                when (response.code()) {
                    200 -> if (body != null) {
                        val question: Question = body
