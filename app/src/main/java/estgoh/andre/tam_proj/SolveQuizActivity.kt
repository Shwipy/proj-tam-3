...
//    }
//
//    fun fillQuestion(questionRoom: QuestionRoom){
...
//        resetButtons()
//
//        val correct_answer = questionRoom.correctAnswer
//        val answer_three = questionRoom.answer3
//        val answer_four = questionRoom.answer4
//
//        val correct_color = ContextCompat.getColor(this, R.color.correct)
//        val wrong_color = ContextCompat.getColor(this, R.color.wrong)
//        val new_text_color = ContextCompat.getColor(this, R.color.white)
//
//        tv_question.text = questionRoom.question
//        btn_op_1.text = questionRoom.answer1
//        btn_op_2.text = questionRoom.answer2
//        btn_op_3.text = questionRoom.answer3
//        btn_op_4.text = questionRoom.answer4
//
...
//        if (questionRoom.img != null){
//            lifecycleScope.launch(Dispatchers.IO){
//                try {
//                    val url = URL(questionRoom.img)
