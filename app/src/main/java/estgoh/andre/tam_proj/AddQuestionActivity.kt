        ...
        btn_add.setOnClickListener {
            ...
            if(!question.trim().isEmpty()){
                ...
                if ( correct_answer == null || correct_answer > num_answers){
                    ...
                    val entry = Question(quizId = quizId, question = question, correctAnswer = correct_answer, answer1 = answer_one, answer2 = answer_two, img = img_url)
                    ...
                    val entry = Question(quizId = quizId, question = question, correctAnswer = correct_answer, answer1 = answer_one, answer2 = answer_two, answer3 = answer_three, img = img_url)
                    Daos(this).question.insert(entry)
                    ...
                    val entry = Question(quizId = quizId, question = question, correctAnswer = correct_answer, answer1 = answer_one, answer2 = answer_two, answer3 = answer_three, answer4 = answer_four, img = img_url)
                    Daos(this).question.insert(entry)
